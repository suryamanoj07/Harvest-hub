...
export const LoginPopup = () => {
  return (
    <div>
        <span className="bg-blue-600 text-black font-bold  mx-20 text-3xl p-4">Choose Your Login</span>
        <div className="flex gap-20 border-blue-600 border-4 rounded-lg p-4 bg-blue-200">
